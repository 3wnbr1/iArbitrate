...
func diskAppeard(_ disk: DADisk, _ context: UnsafeMutableRawPointer?) -> Void {
...
func diskDisappeard(_ disk: DADisk, _ context: UnsafeMutableRawPointer?) -> Void {
    print("[-] Disk \(String(describing: DADiskGetBSDName(disk)))")
}
